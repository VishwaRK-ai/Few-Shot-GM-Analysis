...
def calc_metric(metric, **kwargs): # See metric_utils.MetricOptions for the full list of arguments.
    ...
    opts = metric_utils_ex.MetricOptions(**kwargs)
...
#----------------------------------------------------------------------------
# Custom 5k Metrics for Fast Evaluation
...
def pr5k3_full(opts):
    ...
    return dict(pr5k3_full_precision=precision, pr5k3_full_recall=recall)
#----------------------------------------------------------------------------
